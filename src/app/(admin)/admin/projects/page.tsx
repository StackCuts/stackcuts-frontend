...
Moon, Sun, Search, Plus, MoreHorizontal, Building2,
PlusCircle, Clock, Video, Eye, CheckCircle2, User,
Download
} from "lucide-react";
  ...
  <main className="flex-1 flex flex-col overflow-hidden bg-gray-50 dark:bg-gray-950">
    ...
    <header className="h-20 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-8 flex items-center justify-between shrink-0">
      <div className="flex items-center gap-4">
        <h2 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Projects Pipeline</h2>
        <span className="bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 text-xs font-bold px-2.5 py-1 rounded-md border border-gray-200 dark:border-gray-700 uppercase tracking-wider mt-1">Q3 2026</span>
      </div>
      ...
      <div className="flex gap-6 h-full items-start min-w-max pb-4">
        ...
        <div className="w-80 flex flex-col h-full shrink-0">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-gray-600 dark:text-gray-400 flex items-center gap-2 uppercase tracking-wider text-sm">
              Onboarding
              <span className="bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-[10px] px-2 py-0.5 rounded-full font-black">1</span>
            </h3>
            <button className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" title="Column Options"><MoreHorizontal className="w-5 h-5" /></button>
          </div>
          <div className="space-y-4">
            <Link href="/admin/projects/1" className="block">
              <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-5 rounded-2xl shadow-sm hover:shadow-md hover:border-indigo-300 dark:hover:border-indigo-500/50 transition-all cursor-pointer">
                <h4 className="font-black text-slate-900 dark:text-white mb-3 text-sm leading-tight">Winter Conversion Ad</h4>
                <div className="flex flex-col gap-3">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800/50 px-3 py-2 rounded-xl border border-gray-100 dark:border-gray-800">
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-black tracking-widest mb-0.5">Status</p>
                    <p className="text-xs text-slate-700 dark:text-slate-300 font-bold">Setting up account</p>
                  </div>
                </div>
              </div>
            </Link>
        ...
        <div className="w-80 flex flex-col h-full shrink-0">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-gray-600 dark:text-gray-400 flex items-center gap-2 uppercase tracking-wider text-sm">
              Assets Status
              <span className="bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-800/50 text-[10px] px-2 py-0.5 rounded-full font-black">2</span>
            </h3>
            <button className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" title="Column Options"><MoreHorizontal className="w-5 h-5" /></button>
          </div>
          <div className="space-y-4">
            <Link href="/admin/projects/1" className="block">
              <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-5 rounded-2xl shadow-sm hover:shadow-md hover:border-red-300 dark:hover:border-red-500/50 transition-all cursor-pointer">
                <h4 className="font-black text-slate-900 dark:text-white mb-3 text-sm leading-tight">Founder Story Hook</h4>
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-2 text-xs font-bold text-gray-500 dark:text-gray-400">
                    <Building2 className="w-4 h-4" /> TECHFLOW
                  </div>
                  <div className="bg-red-50 dark:bg-red-900/20 px-3 py-2 rounded-xl border border-red-100 dark:border-red-900/30">
                    <p className="text-[10px] text-red-500 dark:text-red-400 uppercase font-black tracking-widest mb-0.5">Status</p>
                    <p className="text-xs text-red-700 dark:text-red-300 font-bold">Waiting on Logos</p>
                  </div>
                </div>
              </div>
            </Link>
        ...
        <div className="w-80 flex flex-col h-full shrink-0">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-gray-600 dark:text-gray-400 flex items-center gap-2 uppercase tracking-wider text-sm">
              In Production
              <span className="bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 border border-purple-200 dark:border-purple-800/50 text-[10px] px-2 py-0.5 rounded-full font-black">3</span>
            </h3>
            <button className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" title="Column Options"><MoreHorizontal className="w-5 h-5" /></button>
          </div>
          <div className="space-y-4">
            <Link href="/admin/projects/1" className="block">
              <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden hover:shadow-md hover:border-indigo-300 dark:hover:border-indigo-500/50 transition-all cursor-pointer group flex flex-col">
                ...
                <div className="p-5 flex flex-col flex-1">
                  <h4 className="font-black text-slate-900 dark:text-white mb-2 text-sm leading-tight">Summer SaaS Campaign</h4>
                  <div className="flex items-center gap-2 mb-4">
                    <span className="text-[10px] px-2 py-1 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 rounded-md font-bold uppercase tracking-wider">VERTICAL FORMAT</span>
                  </div>
                  <div className="flex items-center justify-between border-t border-gray-100 dark:border-gray-800 pt-4 mt-auto">
                    ...
                    <div className="w-7 h-7 rounded-full bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center text-[10px] font-bold text-indigo-700 dark:text-indigo-400 ring-2 ring-white dark:ring-gray-900">JD</div>
                  </div>
                </div>
              </div>
            </Link>
        ...
        <div className="w-80 flex flex-col h-full shrink-0">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-gray-600 dark:text-gray-400 flex items-center gap-2 uppercase tracking-wider text-sm">
              In Review
              <span className="bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border border-blue-200 dark:border-blue-800/50 text-[10px] px-2 py-0.5 rounded-full font-black">1</span>
            </h3>
            <button className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" title="Column Options"><MoreHorizontal className="w-5 h-5" /></button>
          </div>
          <div className="space-y-4">
            <Link href="/admin/projects/1" className="block">
              <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden hover:shadow-md hover:border-blue-300 dark:hover:border-blue-500/50 transition-all cursor-pointer flex flex-col group">
                ...
                <div className="p-5 flex flex-col flex-1">
                  <h4 className="font-black text-slate-900 dark:text-white mb-2 text-sm leading-tight">Retargeting Variations</h4>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-4 font-bold tracking-wide">Landscape • 3 Versions</p>
                  <div className="bg-blue-50 dark:bg-blue-900/20 px-3 py-2.5 rounded-xl border border-blue-100 dark:border-blue-900/30 flex items-center gap-2 mt-auto">
                    ...
                    <p className="text-xs text-blue-700 dark:text-blue-400 font-bold">Awaiting Client Approval</p>
                  </div>
                </div>
              </div>
            </Link>
          ...
          <div className="space-y-4">
            <Link href="/admin/projects/1" className="block">
              <div className="bg-white dark:bg-gray-900 border-2 border-emerald-100 dark:border-emerald-900/30 p-5 rounded-2xl shadow-sm hover:shadow-md transition-all cursor-pointer relative overflow-hidden flex flex-col">
                ...
                <h4 className="font-black text-slate-900 dark:text-white mb-3 text-sm leading-tight relative z-10">Q3 Promo Ad</h4>
                <div className="flex flex-col gap-3 relative z-10">
                  <div className="flex items-center gap-2 text-xs font-bold text-gray-500 dark:text-gray-400">
                    <User className="w-4 h-4" /> Marcus Thorne
                  </div>
                  <div className="bg-emerald-50 dark:bg-emerald-900/20 px-3 py-2 rounded-xl border border-emerald-100 dark:border-emerald-900/30 flex flex-col">
                    <p className="text-xs text-emerald-700 dark:text-emerald-400 font-black tracking-wide">APPROVED</p>
                    <p className="text-[10px] text-emerald-600 dark:text-emerald-500 font-bold mt-0.5">Ready for download</p>
                  </div>
