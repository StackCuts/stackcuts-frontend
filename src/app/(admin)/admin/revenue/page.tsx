...
export default function AdminRevenuePage() {
  ...
  useEffect(() => {
    ...
    const drawChart = () => {
      ...
      const data = [
        4000, 5200, 4800, 6500, 7800, 9200, 11000, 10500, 12800, 14392,
      ];
      ...
      gradient.addColorStop(
        0,
        isDark ? "rgba(79, 70, 229, 0.4)" : "rgba(79, 70, 229, 0.2)",
      );
        ...
        <header className="h-auto md:h-24 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex flex-col md:flex-row md:items-center justify-between p-6 md:px-8 shrink-0 gap-4">
          <div className="flex flex-col">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mt-1 font-medium">
              Track MRR, cash flow, and manage client invoices.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <button
              className="h-10 px-4 sm:px-5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-sm font-bold rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all flex items-center gap-2 shadow-sm whitespace-nowrap"
              title="Export as CSV"
            >
        ...
        <div className="p-4 md:p-8 flex-1 overflow-y-auto custom-scrollbar flex flex-col gap-6 md:gap-8 max-w-[1400px]">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 shrink-0">
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
              ...
              <p className="text-3xl font-black text-orange-500 dark:text-orange-400 mt-3">
                $3,598
              </p>
              <p className="mt-3 text-gray-500 dark:text-gray-400 text-sm font-medium">
                2 clients pending payment
              </p>
            </div>
          </section>
          ...
          <section className="bg-white dark:bg-gray-900 p-6 md:p-8 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm shrink-0">
            <div className="flex justify-between items-start md:items-center mb-8">
              ...
              <select
                className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-slate-900 dark:text-white text-sm font-semibold rounded-xl px-4 py-2 focus:ring-2 focus:ring-indigo-600 outline-none cursor-pointer"
                title="Select year for growth chart"
              >
                <option>2026</option>
                <option>2025</option>
              </select>
          ...
          <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden flex flex-col shrink-0">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                  ...
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-indigo-100 dark:bg-indigo-900/50 rounded-lg text-xs flex items-center justify-center font-bold text-indigo-700 dark:text-indigo-400">
                          SC
                        </div>
                    ...
                    <td className="px-6 py-5 text-sm font-medium text-gray-600 dark:text-gray-300">
                      Growth Engine - Monthly
                    </td>
                    <td className="px-6 py-5 text-sm font-black text-slate-900 dark:text-white font-mono">
                      $1,799.00
                    </td>
                    <td className="px-6 py-5">
                    ...
                    <td className="px-6 py-5 text-right">
                      <button
                        className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 text-xs font-bold inline-flex items-center gap-1.5 transition-colors"
                  ...
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-emerald-100 dark:bg-emerald-900/50 rounded-lg text-xs flex items-center justify-center font-bold text-emerald-700 dark:text-emerald-400">
                          MT
                        </div>
                        <span className="font-bold text-slate-900 dark:text-white text-sm">
                          Marcus Thorne
                  ...
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-amber-100 dark:bg-amber-900/50 rounded-lg text-xs flex items-center justify-center font-bold text-amber-700 dark:text-amber-400">
                          AC
                        </div>
                        <span className="font-bold text-slate-900 dark:text-white text-sm">
                          Acme Corp
            ...
            <div className="p-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-gray-900/50">
              ...
              <div className="flex gap-2">
                <button
                  className="px-3 py-1.5 text-xs font-bold border border-gray-200 dark:border-gray-700 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors shadow-sm"
                  title="Previous page"
                >
                  Prev
                </button>
                <button
                  className="px-3 py-1.5 text-xs font-bold border border-indigo-600 rounded-lg bg-indigo-600 text-white shadow-sm shadow-indigo-600/20"
                  title="Page 1"
                >
                  1
                </button>
