        ...
        <header className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-6 text-balance">
              Direct Response Ads. Zero Meetings.{" "}
            ...
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-gray-500 dark:text-gray-400 leading-relaxed mb-10">
              StackCuts is the async video agency for modern brands. We turn
              your existing assets into high-converting hybrid ads in 3-5
              business days—without the hassle of filming.
            </p>
            <div className="flex flex-col items-center justify-center mb-20">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
                <Link
                  href="/start-project"
                  className="w-full sm:w-auto px-8 py-4 bg-indigo-600 text-white font-bold rounded-lg shadow-lg hover:shadow-indigo-500/20 hover:bg-indigo-700 transition-all"
                >
                  Start Your Project
                </Link>
                <Link
                  href="/storyboard"
                  className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-gray-900 text-slate-900 dark:text-white font-semibold rounded-lg border border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all"
                >
                  ✨ Generate Free AI Storyboard
                </Link>
              </div>
              <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
                🔒 100% Money-Back Guarantee on Script Approval
              </p>
            </div>
              ...
              <div className="flex flex-col md:flex-row bg-white dark:bg-gray-900 aspect-video md:aspect-auto">
                <aside className="hidden md:block w-48 border-r border-gray-100 dark:border-gray-800 p-4 text-left">
                  ...
                  <div className="space-y-2">
                    <div className="h-6 w-full bg-indigo-50 dark:bg-indigo-900/30 rounded text-[10px] text-indigo-600 dark:text-indigo-400 flex items-center px-2 font-medium">
                      Script Generation
                    </div>
                    <div className="h-6 w-full hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded text-[10px] text-gray-500 dark:text-gray-400 flex items-center px-2">
                      The UGC Hook
                    </div>
                    <div className="h-6 w-full hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded text-[10px] text-gray-500 dark:text-gray-400 flex items-center px-2">
                      UI Screencast & Montage
                    </div>
                    <div className="h-6 w-full hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded text-[10px] text-gray-500 dark:text-gray-400 flex items-center px-2">
                      CTA
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white">
                Recent Work: High-Converting Hybrid Ads
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                {
                  title: "E-commerce Hook",
                  metric: "Scaleable social creative",
                },
                {
                  title: "Web3 Explainer",
                  metric: "Engagement focused montage",
                },
              ].map((item, i) => (
                <div
                  key={i}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-4xl font-extrabold text-slate-900 dark:text-white mb-4">
                Our Signature 4-Part Hybrid Formula
              </h2>
              <p className="text-gray-500 dark:text-gray-400">
                The structure behind every 7-figure creative we deliver.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
              <div className="relative z-10 formula-connector group">
                <div className="bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 rounded-xl p-6 shadow-sm hover:border-indigo-300 dark:hover:border-indigo-600 transition-colors h-full">
                  <div className="text-indigo-600 dark:text-indigo-400 text-xs font-bold mb-4 uppercase tracking-widest">
                    Part 1
                  </div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                    A hyper-realistic person addresses the specific user pain
                    point within 1.5 seconds.
                  </p>
                </div>
              </div>
              <div className="relative z-10 formula-connector group">
                <div className="bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 rounded-xl p-6 shadow-sm hover:border-indigo-300 dark:hover:border-indigo-600 transition-colors h-full">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                    Smooth transition to your product dashboard in action,
              ...
              <div className="relative z-10 formula-connector group">
                <div className="bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 rounded-xl p-6 shadow-sm hover:border-indigo-300 dark:hover:border-indigo-600 transition-colors h-full">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                    Dynamic B-roll that maintains engagement and rhythm through
                    fast-paced editing.
                  </p>
                </div>
              </div>
              <div className="relative z-10 group">
                <div className="bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 rounded-xl p-6 shadow-sm hover:border-indigo-300 dark:hover:border-indigo-600 transition-colors h-full">
                  ...
                  <div className="mb-4 aspect-square bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border-2 border-dashed border-indigo-200 dark:border-indigo-800 flex flex-col items-center justify-center p-4">
                    <div className="text-indigo-600 dark:text-indigo-400 font-bold text-center text-xs">
                      LATEST DEAL:
                      <br />
                      50% OFF TODAY!
                    </div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                    Final punchy text animation that drives the click and
                    increases CTR.
                  </p>
                </div>
              </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto bg-indigo-600 rounded-3xl p-8 md:p-16 text-center shadow-2xl shadow-indigo-600/20 dark:shadow-none relative overflow-hidden">
            ...
            <p className="text-indigo-100 text-lg mb-8 max-w-xl mx-auto relative z-10">
              Get your first high-converting video ad delivered in 3-5 business
              days. No subscriptions, just pure performance.
            </p>
            <p className="text-white font-bold mb-8 relative z-10 text-sm md:text-base">
              ⚡ Founder's Launch Offer: Get your first Hybrid Ad for $199
              (Normally $499). Limited to 5 spots.
            </p>
            <Link
              href="/start-project"
              className="inline-block bg-white text-indigo-600 px-10 py-5 rounded-lg text-lg font-bold hover:bg-gray-50 transition-all shadow-lg hover:-translate-y-1 relative z-10"
            >
              Launch Your Hybrid Ad — $199
            </Link>
          </div>
        </section>
      </main>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
            <div>
              <span className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
                <div className="w-6 h-6 bg-indigo-600 rounded text-white flex items-center justify-center text-xs">
                  S
                </div>
                StackCuts
              </span>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                © 2026 StackCuts Inc. All rights reserved.
              </p>
            </div>
            <div className="flex space-x-8">
              <a
                className="text-sm font-medium text-gray-500 hover:text-slate-900 dark:text-gray-400 dark:hover:text-white"
                href="#"
              >
                Privacy Policy
              </a>
              ...
              <div className="w-full md:w-1/3 p-8 flex flex-col">
                ...
                <div className="space-y-4 mb-8 flex-1">
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    ...
                    focused on time-savings, followed by a{" "}
                    <strong className="text-slate-900 dark:text-white">
                      UI walkthrough
                    </strong>{" "}
                    showing the core automation feature.
                  </p>
                ...
                <Link
                  href="/start-project"
                  className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-lg flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
                >
