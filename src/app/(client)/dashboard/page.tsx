...
export default function ClientDashboardPage() {
  ...
  const activeProjectsCount = userProjects.filter(
    (p) => p.status !== "completed" && p.status !== "handoff",
  ).length;
  const completedProjectsCount = userProjects.filter(
    (p) => p.status === "completed" || p.status === "handoff",
  ).length;
  ...
  return (
    <div className="flex bg-gray-50 dark:bg-slate-950 min-h-screen font-sans text-slate-900 dark:text-slate-100">
      {/* Desktop Sidebar */}
      <aside
        className={`w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex-col h-screen sticky top-0 shrink-0 hidden md:flex`}
      >
        <div className="p-6">
        ...
        <div className="mt-auto p-4 border-t border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer transition-colors">
            <div className="w-10 h-10 rounded-full bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center text-indigo-600 dark:text-indigo-400 font-bold shrink-0 uppercase">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto h-screen">
        ...
        <header className="flex flex-col sm:flex-row sm:items-center justify-between px-6 md:px-8 py-6 md:py-8 gap-4 shrink-0">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm md:text-base mt-1 font-medium">
              Here is the status of your ad campaigns.
            </p>
          </div>
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <Link
              href="/project"
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2.5 px-4 md:px-5 rounded-lg flex items-center gap-2 shadow-lg shadow-indigo-600/20 transition-all active:scale-[0.98] whitespace-nowrap text-sm md:text-base"
            >
        ...
        <div className="px-6 md:px-8 pb-10 space-y-8 flex-1">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-gray-900/50">
              ...
              <button className="text-gray-500 dark:text-gray-400 text-sm font-semibold hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                View all
              </button>
            </div>
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                  {userProjects.length > 0 ? (
                      ...
                      switch (project.status) {
                        ...
                        case undefined:
                          ...
                          actionButton = (
                            <Link
                              href="/project"
                              className="inline-block bg-indigo-600 text-white text-sm font-bold px-5 py-2 rounded-lg hover:bg-indigo-700 transition-all shadow-sm"
                            >
                              View Brief
                            </Link>
                          );
                        ...
                        >
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              <div className="w-9 h-9 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg flex items-center justify-center border border-indigo-100 dark:border-indigo-900/30">
                          ...
                          <td className="px-6 py-4 text-sm text-gray-500 dark:text-gray-400 font-medium capitalize">
                            {project.selectedFormat || "TBD"}
                          </td>
                    ...
                    <tr>
                      ...
                      >
                        No recent projects. Start a new campaign to see it here!
                      </td>
                    </tr>
                  )}
                </tbody>
          ...
          <div className="bg-indigo-50 dark:bg-indigo-900/10 border border-indigo-100 dark:border-indigo-900/50 rounded-2xl p-8 relative overflow-hidden">
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-600 dark:text-gray-300 max-w-xl text-sm md:text-base leading-relaxed">
                  Drop a new link and our AI will generate fresh hooks and
                  variations tailored for your brand voice in under 48 hours.
                </p>
              </div>
              <Link
                href="/project"
                className="whitespace-nowrap bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3.5 px-8 rounded-xl shadow-lg shadow-indigo-600/30 transition-all flex items-center justify-center gap-2 w-full md:w-auto active:scale-[0.98]"
              >
            ...
            <div className="absolute right-0 top-0 h-full w-1/3 opacity-5 pointer-events-none hidden md:block">
              <svg
                className="h-full w-full text-indigo-600 fill-current"
                viewBox="0 0 200 200"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
                  d="M44.7,-76.4C58.1,-69.2,69.2,-58.1,77.8,-44.7C86.4,-31.3,92.5,-15.7,92.5,0C92.5,15.7,86.4,31.3,77.8,44.7C69.2,58.1,58.1,69.2,44.7,77.8C31.3,86.4,15.7,92.5,0,92.5C-15.7,92.5,-31.3,86.4,-44.7,77.8C-58.1,69.2,-69.2,58.1,-77.8,44.7C-86.4,31.3,-92.5,15.7,-92.5,0C-92.5,-15.7,-86.4,-31.3,-77.8,-44.7C-69.2,-58.1,-58.1,-69.2,-44.7,-76.4C-31.3,-83.6,-15.7,-89.7,0,-89.7C15.7,-89.7,31.3,-83.6,44.7,-76.4Z"
