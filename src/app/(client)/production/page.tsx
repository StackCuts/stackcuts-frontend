        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <div className="flex items-center gap-2 opacity-50">
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-500 text-[10px] font-medium">
                1
              </span>
            ...
            <div className="flex items-center gap-2">
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-indigo-600 text-white text-[10px] font-medium shadow-md shadow-indigo-600/20">
                2
              </span>
            ...
            <div className="flex items-center gap-2 opacity-40">
              <span className="flex items-center justify-center w-6 h-6 rounded-full border border-gray-300 dark:border-gray-700 text-gray-500 text-[10px] font-medium">
                3
              </span>
              <span className="text-gray-500 text-sm font-medium whitespace-nowrap">
                Review
      ...
      <main className="flex-grow max-w-7xl mx-auto w-full p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-12 gap-8 mt-2">
        ...
        <section className="lg:col-span-7 flex flex-col gap-6">
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden p-6 sm:p-10 flex flex-col items-center text-center h-full relative">
            ...
            <span className="text-xs font-bold tracking-widest text-gray-400 dark:text-gray-500 uppercase mb-8">
              ACTIVE PRODUCTION
            </span>
            ...
            <div className="w-full max-w-md text-left space-y-8 relative pl-4 sm:pl-0">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="pt-0.5">
                  <span className="text-gray-500 dark:text-gray-400 font-medium block text-sm">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="pt-0.5">
                  <span className="text-indigo-600 dark:text-indigo-400 font-bold block text-sm tracking-wide">
                    2. Digital Avatar Hook & Scripting
                  </span>
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
                    Crafting a high-converting direct response script...
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 opacity-40">
                ...
                <div className="pt-0.5">
                  <span className="text-gray-600 dark:text-gray-300 font-medium block text-sm">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                    Your first draft will be ready for review within 3-5
                    business days. We’ll email you the moment it drops.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow group">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                    You’ll be able to leave frame-accurate feedback directly on
                    the video during the next step.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow group">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                    While your video is in production, we are finalizing your
                    direct response ad copy to match the visual hook.
                  </p>
                </div>
              </div>
            </div>
