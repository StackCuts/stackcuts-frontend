        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-2 text-gray-400 dark:text-gray-500 font-medium text-sm">
              <span className="flex h-6 w-6 items-center justify-center rounded-full border border-gray-300 dark:border-gray-700 text-[10px]">
                2
              </span>
          ...
          <div className="max-w-2xl mx-auto space-y-10 pb-20 md:pb-0">
            ...
            <div className="group relative rounded-xl border-2 border-dashed border-indigo-600/30 dark:border-indigo-500/30 bg-indigo-50/50 dark:bg-indigo-900/10 p-12 transition-all hover:border-indigo-600/60 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                No raw footage needed. We handle the direct response script and
                the digital avatar hook.
              </p>
              <button
                type="button"
        ...
        <aside className="flex-1 md:w-[40%] bg-gray-50 dark:bg-gray-900/30 relative flex flex-col h-[60vh] md:h-full border-t md:border-t-0 md:border-l border-gray-200 dark:border-gray-800 shrink-0">
          <div className="flex-1 overflow-y-auto p-6 md:p-10 lg:p-12 pb-32 custom-scrollbar">
            <div className="flex items-center justify-between mb-8">
              ...
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 text-[10px] font-bold uppercase tracking-wider border border-emerald-500/20">
                🔒 Secure Workspace
              </span>
            </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      id="project-name"
                      type="text"
                      value="Summer SaaS Campaign"
                      disabled
                      className="w-full bg-gray-100 dark:bg-gray-900/50 border-gray-200 dark:border-gray-800 rounded-lg text-sm text-gray-500 dark:text-gray-400 font-medium px-4 py-2.5 cursor-not-allowed outline-none"
                    />
                  </div>
                  <div>
                    <label
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      id="target-audience"
                      rows={2}
                      placeholder="e.g. Marketing Managers in Series A Startups"
                      className="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm focus:ring-2 focus:ring-indigo-600 outline-none px-4 py-2.5 resize-none dark:text-white placeholder:text-gray-400"
                    ></textarea>
                  </div>
                  <div>
                    <label
                    ...
                    <textarea
                      id="pain-point"
                      rows={2}
                      placeholder="e.g. Too much manual data entry across multiple tools"
                      className="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm focus:ring-2 focus:ring-indigo-600 outline-none px-4 py-2.5 resize-none dark:text-white placeholder:text-gray-400"
                    ></textarea>
                  </div>
                  <div>
                    ...
                    <input
                      id="cta"
                      type="text"
                      placeholder="e.g. Book a free 15-min workflow audit"
                      className="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm focus:ring-2 focus:ring-indigo-600 outline-none px-4 py-2.5 dark:text-white placeholder:text-gray-400"
                    />
                  </div>
                  <div>
                    <label
                  ...
                  <div>
                    ...
                    <textarea
                      id="do-not-list"
                      rows={2}
                      placeholder="Words or competitors to avoid..."
                      className="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm focus:ring-2 focus:ring-indigo-600 outline-none px-4 py-2.5 resize-none dark:text-white placeholder:text-gray-400"
                    ></textarea>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    >
                      ...
                      />
                      <span
                        className={`text-sm ${selectedFormat === option.id ? "font-semibold text-slate-900 dark:text-white" : "font-medium text-gray-600 dark:text-gray-400"}`}
                      >
                        {option.label}
                      </span>
                    </label>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 bg-gradient-to-t from-gray-50 via-gray-50 dark:from-gray-900/90 dark:via-gray-900/90 to-transparent">
            <Link
              href="/production"
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-4 rounded-xl font-bold text-base shadow-xl shadow-indigo-600/30 transition-all flex items-center justify-center gap-2 group active:scale-[0.98]"
            >
              Submit Brief & Start Production
