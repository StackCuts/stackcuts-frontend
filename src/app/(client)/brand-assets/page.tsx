...
Sun, Moon, Bell, Menu, Palette, BrainCircuit, Play,
UploadCloud, Plus, Edit2, ChevronDown, Video
} from "lucide-react";
  ...
  <aside className={`w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex-col h-screen sticky top-0 shrink-0 hidden md:flex z-20`}>
    <div className="p-6">
      ...
      <nav className="space-y-1.5">
        ...
        {/* Active State */}
        <Link href="/brand-assets" className="flex items-center gap-3 px-3 py-2.5 rounded-lg font-semibold text-sm transition-colors bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 border-r-4 border-indigo-600">
  ...
  <main className="flex-1 flex flex-col min-w-0 overflow-y-auto h-screen relative custom-scrollbar">
    ...
    <div className="max-w-[1200px] w-full mx-auto p-6 md:p-8 pb-32">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div className="flex flex-col gap-2">
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Brand Assets</h2>
          <p className="text-gray-500 dark:text-gray-400 text-sm md:text-base max-w-2xl">
            Centralize your visual identity to power AI video generation. Consistent inputs yield consistent outputs.
          </p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <button className="p-2.5 rounded-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-gray-600 dark:text-gray-300 relative" title="Notifications">
        ...
        <div className="lg:col-span-7 flex flex-col gap-8">
          ...
          <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-gray-900/50">
              <h3 className="font-bold text-lg text-slate-900 dark:text-white">The Identity Kit</h3>
            ...
            <div className="p-6 flex flex-col gap-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                  <span className="text-xs font-bold uppercase tracking-wider text-gray-500">Primary Logo</span>
                  <div className="group relative flex aspect-video cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-500 transition-colors bg-gray-50 dark:bg-gray-800/30">
                    <div className="w-16 h-16 bg-indigo-600 rounded-lg flex items-center justify-center text-white font-black text-2xl opacity-80">SC</div>
                ...
                <div className="flex flex-col gap-2">
                  <span className="text-xs font-bold uppercase tracking-wider text-gray-500">Secondary Logo</span>
                  <div className="group flex aspect-video cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-500 transition-colors bg-gray-50 dark:bg-gray-800/30">
                    <Plus className="w-8 h-8 text-gray-400 group-hover:text-indigo-600 transition-colors" />
                    <span className="text-xs text-gray-500 mt-2 font-medium">Upload .SVG or .PNG</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <span className="text-xs font-bold uppercase tracking-wider text-gray-500">Brand Palette</span>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="flex items-center gap-3 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm">
                    <div className="h-8 w-8 rounded-full border border-black/10 dark:border-white/10 shadow-sm bg-[#4F46E5]"></div>
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase font-bold text-gray-400">Primary</span>
                      <input type="text" defaultValue="#4F46E5" title="Primary Color" className="p-0 border-none bg-transparent text-sm font-mono font-medium text-slate-900 dark:text-white w-20 focus:ring-0" />
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm">
                    <div className="h-8 w-8 rounded-full border border-black/10 dark:border-white/10 shadow-sm bg-[#111827]"></div>
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase font-bold text-gray-400">Dark</span>
                      <input type="text" defaultValue="#111827" title="Dark Color" className="p-0 border-none bg-transparent text-sm font-mono font-medium text-slate-900 dark:text-white w-20 focus:ring-0" />
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm cursor-pointer hover:border-indigo-300 dark:hover:border-indigo-700 transition-colors group" title="Add Color">
                    ...
                    <div className="flex flex-col">
                      <span className="text-xs font-semibold text-gray-500">Add Color</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Typography */}
              <div className="flex flex-col gap-2">
                <span className="text-xs font-bold uppercase tracking-wider text-gray-500">Primary Font</span>
                <div className="relative">
                  <select title="Primary Font" className="w-full appearance-none rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 py-3 pl-4 pr-10 text-sm font-medium text-slate-900 dark:text-white focus:border-indigo-600 focus:outline-none focus:ring-1 focus:ring-indigo-600 shadow-sm">
                    <option>Inter</option>
          ...
          <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
            ...
            <div className="p-6 flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-slate-900 dark:text-white">Brand Voice</label>
                <div className="relative">
                  <select title="Brand Voice" className="w-full appearance-none rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 py-3 pl-4 pr-10 text-sm font-medium text-slate-900 dark:text-white focus:border-indigo-600 focus:outline-none focus:ring-1 focus:ring-indigo-600 shadow-sm">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-baseline">
                  <label htmlFor="negative-constraints" className="text-sm font-semibold text-slate-900 dark:text-white">Do Not List (Negative Constraints)</label>
                  <span className="text-xs text-gray-500">AI will avoid these traits</span>
                </div>
                <textarea 
          ...
          <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm h-full flex flex-col">
            <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-gray-900/50">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 font-medium">Upload approved B-roll for reuse.</p>
              </div>
            ...
            <div className="p-6 flex flex-col gap-6 flex-1">
              ...
              <div className="group relative flex w-full cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/30 py-8 hover:border-indigo-600 hover:bg-indigo-50 dark:hover:border-indigo-500 dark:hover:bg-indigo-900/10 transition-all">
                ...
                <input title="Upload Asset" type="file" className="absolute inset-0 opacity-0 cursor-pointer" />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={idx} className="relative aspect-square rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-800 group shadow-sm">
                    ...
                    <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
                      <button className="text-white bg-black/50 rounded-full p-2 hover:bg-indigo-600 transition-colors backdrop-blur-md" title="Play Asset">
    ...
    <footer className="fixed bottom-0 right-0 w-full md:w-[calc(100%-16rem)] z-30 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-t border-gray-200 dark:border-gray-800 px-6 md:px-8 py-4 flex justify-between items-center shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
      ...
      <div className="flex gap-3 sm:gap-4">
        ...
        <button className="px-5 sm:px-6 py-2.5 rounded-lg bg-indigo-600 text-sm font-bold text-white shadow-md shadow-indigo-600/20 hover:bg-indigo-700 transition-all active:scale-95">
          Save Profile
        </button>
      </div>
    </footer>
