    ...
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm font-semibold text-gray-600 dark:text-gray-300 truncate max-w-[150px] md:max-w-none">
            Summer SaaS Campaign
          </span>
          {activeStep === 4 && (
            <span className="px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800 hidden lg:block">
              Completed
            </span>
          )}
        </div>
            ...
            <React.Fragment key={step}>
              ...
              >
                {isCompleted ? (
                  ...
                  <span
                    className={`w-5 h-5 flex items-center justify-center rounded-full text-[10px] font-bold ${isActive ? "bg-indigo-600 text-white shadow-sm" : "bg-gray-200 dark:bg-gray-800 text-gray-500"}`}
                  >
                    {stepNum}
                  </span>
                )}
                <span
                  className={`text-xs font-bold ${isActive ? "text-slate-900 dark:text-white" : "text-gray-500 dark:text-gray-400"}`}
                >
                  {step}
                </span>
              </div>
              {idx < steps.length - 1 && (
                <div
                  className={`h-px flex-1 mx-2 ${isCompleted ? "bg-indigo-600 dark:bg-indigo-500" : "bg-gray-200 dark:bg-gray-800"}`}
                ></div>
              )}
            </React.Fragment>
          );
      ...
      <div className="max-w-2xl mx-auto space-y-10 pb-20 md:pb-0">
        <header>
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Upload your core brand files. We&apos;ll handle the rest.
          </p>
        </header>
        <div className="group relative rounded-xl border-2 border-dashed border-indigo-600/30 dark:border-indigo-500/30 bg-indigo-50/50 dark:bg-indigo-900/10 p-12 transition-all hover:border-indigo-600/60 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 flex flex-col items-center text-center">
          ...
          <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-1">
            Drop your logos, fonts, UI screenshots, or screencasts here.
          </h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
            No raw footage needed. Our AI handles the script and the UGC hook.
          </p>
          <button
            title="Browse Files"
            type="button"
            className="bg-indigo-600 text-white px-6 py-2.5 rounded-lg font-bold text-sm tracking-wide shadow-lg shadow-indigo-600/20 hover:brightness-110 transition-all pointer-events-none"
          >
            Browse Files
          </button>
          <input
    ...
    <aside className="flex-1 md:w-[40%] bg-gray-50 dark:bg-gray-900/30 relative flex flex-col h-[60vh] md:h-full border-t md:border-t-0 md:border-l border-gray-200 dark:border-gray-800 shrink-0">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Summer SaaS Campaign"
                  className="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm text-slate-900 dark:text-white font-medium px-4 py-2.5 outline-none focus:ring-2 focus:ring-indigo-600"
                />
              </div>
              <div>
                <label
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="Marketing Managers in Series A Startups"
                  className="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm focus:ring-2 focus:ring-indigo-600 outline-none px-4 py-2.5 resize-none dark:text-white"
                ></textarea>
              </div>
              <div>
                <label
                ...
                <select
                  ...
                  title="Brand Voice"
                  className="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm focus:ring-2 focus:ring-indigo-600 outline-none px-4 py-2.5 dark:text-white"
                >
            ...
            <div className="space-y-3">
              {[
                ...
                <label
                  ...
                  className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${selectedFormat === option.id ? "border-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:border-indigo-500" : "border-gray-200 dark:border-gray-800 hover:bg-white dark:hover:bg-gray-900"}`}
                >
                  <input
                    type="radio"
                    name="format"
                  ...
                  />
                  <span
                    className={`text-sm ${selectedFormat === option.id ? "font-semibold text-slate-900 dark:text-white" : "font-medium text-gray-600"}`}
                  >
                    {option.label}
                  </span>
                </label>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 bg-gradient-to-t from-gray-50 via-gray-50 dark:from-gray-900/90 dark:via-gray-900/90 to-transparent">
        <button
          ...
          className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed text-white py-4 rounded-xl font-bold text-base shadow-xl shadow-indigo-600/30 transition-all flex items-center justify-center gap-2 group"
        >
          {isSubmitting ? (
  ...
  <main className="flex-grow max-w-7xl mx-auto w-full p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-12 gap-8 mt-2 overflow-y-auto custom-scrollbar">
    ...
    <section className="lg:col-span-7 flex flex-col gap-6">
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-10 flex flex-col items-center text-center relative">
        ...
        <h2 className="text-3xl font-bold mb-10 tracking-tight text-slate-900 dark:text-white">
          Assembling your hybrid ad.
        </h2>
        <div className="w-full max-w-sm text-left space-y-8">
          <div className="flex items-center gap-4">
            ...
            <span className="text-gray-500 text-sm font-medium">
              1. Strategic Brief Analyzed
            </span>
          </div>
          <div className="flex items-center gap-4">
            <div className="spinner"></div>
            <span className="text-indigo-600 dark:text-indigo-400 font-bold text-sm">
              2. AI Hook Generation & Scripting
            </span>
          </div>
          <div className="flex items-center gap-4 opacity-40">
            <div className="w-6 h-6 rounded-full border-2 border-gray-300"></div>
            <span className="text-gray-600 text-sm font-medium">
              3. Screencast & Montage Assembly
            </span>
          </div>
          <div className="flex items-center gap-4 opacity-40">
            <div className="w-6 h-6 rounded-full border-2 border-gray-300"></div>
            <span className="text-gray-600 text-sm font-medium">
              4. Motion Graphics & Final Polish
            </span>
          </div>
        </div>
        ...
        <button
          onClick={onNext}
          className="mt-8 text-xs text-gray-400 hover:text-indigo-600 underline"
        >
          {" "}
          (Simulate Production Complete){" "}
        </button>
      </div>
    </section>
        ...
        {[
          {
            ...
            text: "Your first draft will be ready within 48 hours.",
          },
          {
            icon: Eye,
            title: "The Review Process",
            text: "You'll leave frame-accurate feedback in the next step.",
          },
        ].map((item, i) => (
          <div
            key={i}
  ...
  <main className="flex flex-col lg:flex-row flex-1 overflow-hidden max-w-[1440px] mx-auto w-full">
    <section className="w-full lg:w-[65%] flex flex-col bg-gray-50 dark:bg-black/20 p-4 md:p-8 overflow-y-auto custom-scrollbar border-r border-gray-200 dark:border-gray-800">
      <div className="max-w-5xl mx-auto w-full space-y-6">
        <div className="relative group aspect-video bg-black rounded-xl overflow-hidden shadow-2xl flex items-center justify-center">
          ...
          <button
            title="Play Video"
            className="z-10 w-20 h-20 bg-indigo-600/90 text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform"
          >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4">
          ...
          <button
            onClick={onNext}
            className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-8 py-3 rounded-lg shadow-lg flex items-center justify-center gap-2"
          >
    ...
    <aside className="w-full lg:w-[35%] bg-gray-50 dark:bg-gray-900/30 flex flex-col h-[50vh] lg:h-full border-t lg:border-t-0 border-gray-200 dark:border-gray-800">
      <div className="p-6 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between bg-white dark:bg-gray-900">
        ...
        <button title="Filter" className="text-gray-500">
      ...
      <div className="p-6">
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
          <textarea
            className="w-full p-4 text-sm resize-none h-24 bg-transparent dark:text-white"
            placeholder="Leave a note at 0:12..."
          ></textarea>
          <div className="flex items-center justify-between px-4 py-2 bg-gray-50 dark:bg-gray-800/50">
            ...
            <button className="bg-indigo-600 text-white text-xs font-bold px-4 py-1.5 rounded-lg">
              Post
            </button>
          </div>
        </div>
    ...
    <section className="lg:col-span-8 space-y-8">
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
        <div className="aspect-video relative group bg-black flex items-center justify-center">
          ...
          <button
            ...
            className="z-10 w-24 h-24 bg-white/10 backdrop-blur-md text-white rounded-full flex items-center justify-center hover:bg-white/20 transition-all border border-white/20"
          >
            <Play className="w-10 h-10 ml-1 fill-current text-white" />
          </button>
          <div className="absolute top-6 left-6 flex gap-2">
            <span className="bg-indigo-600 text-white text-[10px] font-bold px-3 py-1 rounded-full shadow-lg">
              FINAL MASTER
            </span>
        ...
        <div className="p-6 flex items-center justify-between border-t border-gray-100 dark:border-gray-800">
          ...
          <div className="flex gap-3">
            <button
              title="Download All"
              className="flex items-center gap-2 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-slate-900 dark:text-white px-5 py-2.5 rounded-xl font-bold text-sm transition-all border border-gray-200 dark:border-gray-700"
            >
              <Download className="w-4 h-4" /> Download All
            </button>
            <button
              title="Send to Platforms"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/30 p-6 rounded-2xl flex items-center gap-5">
          <div className="h-14 w-14 bg-emerald-500 text-white rounded-full flex items-center justify-center shadow-lg shadow-emerald-500/20">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 rounded-2xl flex items-center gap-5 shadow-sm">
          <div className="h-14 w-14 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Includes 3 scroll-stopping hooks.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden shadow-sm">
        <div className="p-5 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-indigo-50/50 to-white dark:from-indigo-900/20 dark:to-gray-900">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Your plug-and-play assets for ad platforms.
          </p>
        </div>
        <div className="p-5 space-y-5">
          {[
            {
              title: "📘 Facebook & IG Captions",
              text: "Stop wasting hours on manual reports. Automate your agency reporting in 1-click. Try it free today 👇",
            },
            {
              title: "🎵 TikTok & Reels Captions",
              text: "POV: You finally found the tool that does your job for you 🤯 #agencylife",
            },
            {
              title: "🎯 Suggested Targeting",
              text: "Interests: 'Digital Marketing', 'Shopify', 'SaaS Founders'. Age: 25-45. Placement: Mobile Feed.",
              isMono: true,
            },
          ].map((item, i) => (
            <div key={i} className="space-y-2">
              ...
              <div className="relative group">
                <div
                  className={`bg-gray-100 dark:bg-gray-800 p-3 rounded-lg text-sm text-gray-600 dark:text-gray-300 pr-10 border border-transparent hover:border-indigo-200 dark:hover:border-indigo-800 transition-colors ${item.isMono ? "font-mono text-xs leading-relaxed" : ""}`}
                >
                  {item.text}
                </div>
                <button
                  title="Copy Text"
                  className="absolute top-2 right-2 p-1.5 rounded-md text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors"
                >
                  {" "}
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm">
        ...
        <div className="flex gap-2 mb-6">
          {[1, 2, 3, 4, 5].map((star) => (
            <Star
              key={star}
              className="w-8 h-8 text-gray-200 dark:text-gray-700 hover:text-amber-400 hover:fill-current cursor-pointer transition-colors"
            />
          ))}
        </div>
        <textarea
          className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 text-sm min-h-[100px] outline-none mb-4 transition-focus focus:ring-2 focus:ring-indigo-600"
          placeholder="Tell us what you liked about your ad..."
        ></textarea>
        <button className="w-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-3 rounded-xl text-sm font-bold hover:opacity-90 active:scale-95 transition-all">
          Submit Review
        </button>
      </div>
    </aside>
...
export default function ProjectWorkspaceSPA() {
  ...
  const [brandVoice, setBrandVoice] = useState("Casual & Creator-Style");
  ...
  return (
    <div
      className={`flex flex-col h-screen bg-gray-50 dark:bg-gray-950 font-sans selection:bg-indigo-100 dark:selection:bg-indigo-900/40 transition-opacity duration-300 ${mounted ? "opacity-100" : "opacity-0"}`}
    >
      <Header
