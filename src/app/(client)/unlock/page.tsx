    ...
    <div className="max-w-5xl w-full">
      ...
      <header className="text-center mb-12 lg:mb-16">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-lg max-w-xl mx-auto">
          Pay the remaining balance to instantly access your non-watermarked video and AI Marketing Launchpad.
        </p>
      </header>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm hover:shadow-md transition-shadow p-6 sm:p-8">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-6">Payment Summary</h2>
          
          <div className="space-y-4 mb-8">
            <div className="flex justify-between items-center text-sm sm:text-base">
              <span className="text-gray-600 dark:text-gray-400">Total Project Price</span>
              <span className="font-medium text-slate-900 dark:text-white">$499.00</span>
            </div>
            <div className="flex justify-between items-center text-sm sm:text-base">
              <span className="text-gray-600 dark:text-gray-400">Less: Deposit Paid</span>
              <span className="font-medium text-emerald-600 dark:text-emerald-400">-$249.50</span>
            </div>
            <hr className="border-gray-100 dark:border-gray-800" />
            <div className="flex justify-between items-center py-2">
              <span className="text-lg font-bold text-slate-900 dark:text-white">BALANCE DUE NOW</span>
              <span className="text-2xl font-black text-slate-900 dark:text-white">$249.50</span>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <div className="flex items-center gap-3">
                <div className="w-10 h-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded flex items-center justify-center">
                  <span className="text-[10px] font-bold italic text-blue-800 dark:text-blue-400">VISA</span>
                </div>
                <div>
                  <p className="text-sm font-semibold text-slate-900 dark:text-white">Visa ending in 1234</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Expires 12/26</p>
                </div>
              </div>
              <button className="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 transition-colors">Edit</button>
            </div>
          </div>
          ...
          <Link 
            href="/final" 
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-lg shadow-indigo-600/20 flex items-center justify-center gap-2 group active:scale-[0.98]"
          >
            <Lock className="w-5 h-5" />
            Pay $249.50 & Unlock Campaign
          </Link>
          <p className="text-center text-xs text-gray-400 dark:text-gray-500 mt-5 leading-relaxed">
            Securely processed via Stripe.<br className="sm:hidden" /> Instant access granted upon successful payment.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="px-2 sm:px-0">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
              <h3 className="text-xl font-bold text-slate-900 dark:text-white">Summer SaaS Campaign <span className="text-gray-500 font-medium">(Final Master)</span></h3>
              <span className="w-fit px-2.5 py-1 rounded-full bg-gray-200 dark:bg-gray-800 text-gray-600 dark:text-gray-400 text-[10px] font-bold tracking-widest uppercase">LOCKED</span>
            </div>
            
            <div className="space-y-6">
              <h4 className="text-xs font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500">Included in this Unlock</h4>
              <ul className="space-y-5">
                {[
                  { title: "High-quality master video", desc: "4K resolution, No Watermarks, Pro-Res & MP4 formats." },
                  { title: "Full Commercial Usage License", desc: "Perpetual rights for digital advertising and social media." },
                  { title: "AI Marketing Launchpad", desc: "Optimized captions for FB, Instagram, and TikTok." },
                  { title: "Suggested Media Buying Data", desc: "Audience interest targeting and bid strategy guide." }
                ].map((item, idx) => (
